    ...
    return (
        <>
            <aside className="sticky top-0 hidden w-96 flex-col gap-6 self-start sm:flex">
                <article className="my-6 flex justify-between gap-4">
                    <div
                        ...
                        <div
                            ...
                            <h2 className="px-5 py-3 font-bold uppercase text-gray-400">My courses</h2>
                    ...
                    <span
                        ...
                        role="button"
                        tabIndex={0}>
                        <div className="pointer-events-none">{streak > 0 ? <FireSvg /> : <EmptyFireSvg />}</div>
                        <span className={streak > 0 ? 'text-orange-500' : 'text-gray-300'}>{streak}</span>
                        <div
                    ...
                    <span
                        ...
                        <span className={lingots > 0 ? 'text-red-500' : 'text-gray-300'}>{lingots}</span>
                        <div
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <Link className="uppercase text-blue-400 transition hover:brightness-110" href="/shop">
                                    Go to shop
                                </Link>
                            </div>
                        </div>
                ...
                <DailyQuestsSection />
                <XpProgressSection />
                {!loggedIn && <CreateAProfileSection setLoginScreenState={setLoginScreenState} />}
            </aside>
        ...
        <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
            ...
            <div className="flex items-center gap-6">
                ...
                <p className="text-sm leading-6 text-gray-500">
                    ...
                    {lessonsNeededToUnlockLeaderboards === 1 ? '' : 's'} to start competing
                </p>
            </div>
        </article>
    );
        ...
        <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
            ...
            <div className="flex gap-6">
                ...
                <div className="flex flex-col gap-5">
                    {rank !== null && <p className="text-lg font-bold text-gray-700">{`You're ranked #${rank}`}</p>}
                    <p className="text-sm leading-6 text-gray-500">You earned {xpThisWeek} XP this week so far</p>
                </div>
            </div>
        </article>
    );
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center">
                        <div className="relative h-5 w-52 rounded-l-full bg-gray-200">
                            <div
                                className={['relative h-full rounded-l-full bg-yellow-400', xpToday === 0 ? '' : 'px-2'].join(' ')}
        ...
        <svg width="76px" height="76px" viewBox="0 0 76 76" {...props}>
            <defs>
                <path
                    ...
                    id="path-1"
                />
                <polygon id="path-3" points="0 0 52.7674684 0 52.7674684 2.18038513 0 2.18038513" />
                <polygon id="path-5" points="0 0 52.7674684 0 52.7674684 2.18038513 0 2.18038513" />
                <path
                    ...
                    id="path-7"
                />
                <polygon id="path-9" points="0 0 45.0722126 0 45.0722126 17.4430811 0 17.4430811" />
                <polygon
                    id="path-11"
                    points="0.0272741852 0.350693145 46.8210364 0.350693145 46.8210364 2.91988456 0.0272741852 2.91988456"
                />
                <polygon id="path-13" points="0 46.28539 0 15.2626959 15.3905116 0 15.3905116 29.4351993 16.9913007 29.4351993" />
                <path
            ...
            <g id="PANEL-CHEST" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="Group-52-Copy" transform="translate(38.500000, 38.000000) rotate(-360.000000) translate(-38.500000, -38.000000)">
...
const CreateAProfileSection = ({ setLoginScreenState }) => {
    return (
