...
import { FireSvg, GemSvg, GlobeIconSvg, LingotsTreasureChestSvg, MoreOptionsSvg, PodcastIconSvg } from './Svgs';
...
export const TopBar = ({ backgroundColor = 'bg-[#58cc02]', borderColor = 'border-[#46a302]' }) => {
    ...
    return (
        <header className="fixed z-20 h-[58px] w-full">
            <div
                ...
                <button onClick={() => setMenu((x) => (x === 'LANGUAGES' ? 'HIDDEN' : 'LANGUAGES'))}>
                            ...
                            case 'LANGUAGES':
                                return (
                                    <div className="flex gap-5 p-5">
                                        ...
                                        <Link className="flex flex-col items-center justify-between gap-2" href="/register">
                            ...
                            case 'STREAK':
                                return (
                                    <div className="flex grow flex-col items-center gap-3 p-5">
                                        ...
                                        <p className="text-sm text-gray-400">{`Practice each day so your streak won't reset!`}</p>
                                        <div className="self-stretch">{/* <Calendar now={now} setNow={setNow} /> */}</div>
                                    </div>
                                );
