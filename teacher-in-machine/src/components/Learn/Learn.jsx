...
const getTileLeftClassName = ({ index, unitNumber, tilesLength }) => {
    ...
    const classNames = unitNumber % 2 === 1 ? tileLeftClassNames : [...tileLeftClassNames.slice(4), ...tileLeftClassNames.slice(0, 4)];
...
const getTileTooltipLeftOffset = ({ index, unitNumber, tilesLength }) => {
    ...
    const offsets =
        unitNumber % 2 === 1 ? tileTooltipLeftOffsets : [...tileTooltipLeftOffsets.slice(4), ...tileTooltipLeftOffsets.slice(0, 4)];
...
const TileTooltip = ({ selectedTile, index, unitNumber, tilesLength, description, status, closeTooltip }) => {
...
const UnitSection = ({ unit }) => {
    ...
    const increaseLessonsCompleted = 0;
    const increaseLingots = 0;
...
const UnitHeader = ({ unitNumber, description, backgroundColor, borderColor }) => {
    const language = 'eng';
    return (
